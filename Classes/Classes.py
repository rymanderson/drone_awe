...
print("Successfully imported `Drone.py`") #Technically these aren't separate .py files, but keeping the extension might be less confusing
...
print("Successfully imported `Rain.py`")
...
print("Successfully imported `Temperature.py`")
...
print("Successfully imported `Humidity.py`")
...
print("Successfully imported `Wind.py`")
